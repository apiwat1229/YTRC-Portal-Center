// src/components/truckscale/DrainMonitorTab.jsx
import {
    Button,
    Group,
    Paper,
...
export default function DrainMonitorTab({ user }) {
    ...
    const handleWeightOutClick = (row) => {
        // TODO: เปิด modal บันทึก Weight Out
        console.log("open weight-out modal", row);
    };
